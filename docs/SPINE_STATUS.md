...
|---|---|---|---|---|
| 1 | #59 | `drift scan --json` missing | 🟡 Medium | ✅ Fixed — branch `claude/fix-drift-scan-json-GsPn6` |
...
| ~~#59~~ | ~~`drift scan --json` missing~~ | ✅ Fixed — branch `claude/fix-drift-scan-json-GsPn6` |
